...
- No GUI app installs except MonitorControl.
- Rejected — do not re-propose: gcloud, postgres, worktrunk, zed, Maccy/Raycast settings, general macOS defaults, GUI casks.
